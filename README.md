...
`pip install git+https://github.com/biomodels/BIOMD0000000133.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000133.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000133 as model`
...
Neurons?_ Figure1(K) resonator has been reproduced by MathSBML. The ODE and
...
parameters and different stimulus function or events. a=0.1; b=0.26; c=-60;
d=-1; V=-62; u=b*V;
